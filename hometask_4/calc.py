...
class Complex_numbers:
    ...
    def __truediv__(self, other):
        try:
            ...
            print("choose another operation or numbers")
...
while True:
    try:
        re1, im1 = map(int, input("Введите первое число ").split())
        re2, im2 = map(int, input("Введите второе число ").split())
        numb1 = Complex_numbers(re1, im1)
        numb2 = Complex_numbers(re2, im2)
